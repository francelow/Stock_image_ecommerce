        ...
        if (substr($name, 0, 8) == "product_"){
          ...
          while($row = fetch_array($query)){
            ...
            <tr>
                ...
                <td>$value</td>
                <td>\$$subtotal</td>
                <td><a class="btn btn-warning" href="../resources/cart.php?remove={$row['product_id']}"><span class="glyphicon glyphicon-minus"></span>  <a class="btn btn-success" href="../resources/cart.php?add={$row['product_id']}"><span class="glyphicon glyphicon-plus"></span>  <a class="btn btn-danger" href="../resources/cart.php?delete={$row['product_id']}"><span class="glyphicon glyphicon-remove"></span>
            </tr>
      ...
      foreach ($_SESSION as $name => $value) {
        if ($value > 0){
          if (substr($name, 0, 8) == "product_"){
            ...
            /* send order variables to the database */
            ...
            $last_id = last_id(); //mysqli_insert_id function
            confirm($send_order);
