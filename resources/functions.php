<?php
  ...
  function sent_message(){
    if (isset($_POST['submit'])){
      $recepient = "someemailaddress@gmail.com";
      $name    = $_POST['name'];
      $email   = $_POST['email'];
  ...
  function escape_string($string){
    global $connection;
    return mysqli_real_escape_string($connection, $string); //Prevent sql injection
  }
...
/**********************************************FRONT END FUNCTIONS**********************************************/
  ...
  function get_categories(){
    $query = query("SELECT * FROM categories"); //query string
    confirm($query);
